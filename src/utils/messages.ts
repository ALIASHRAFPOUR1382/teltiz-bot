...
export function getWelcomeMessage(channelName: string = 'کانال تیزهوشان'): string {
...
export function getCategoryConfirmationMessage(categoryName: string): string {
...
export function getQuizAnnouncementMessage(channelName: string = 'کانال تیزهوشان'): string {
...
export function getQuizQuestionMessage(
...
export function getQuizCompletionMessage(score: number, totalQuestions: number): string {
...
export function getQuizWinnersMessage(
  weekId: string,
  winners: Array<{ user_id: number; score: number; username?: string | null; first_name?: string | null }>,
  channelName: string = 'کانال تیزهوشان'
): string {
...
export function getStartCommandMessage(): string {
  return `سلام! 👋
...
export function getAdminHelpMessage(): string {
